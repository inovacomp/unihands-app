    ...
    render() {
        return (
            <View>
                ...
                <Text onPress={() => { Clipboard.setString('https://siacapi.ayrtonsilas.com.br/api/download-apk'); alert('Link Copiado!') }} style={{ fontSize: 14, fontWeight: 'bold', textDecorationLine: 'underline', textAlign: 'justify', padding: 10 }}>- Link para download, clique para copiar: https://siacapi.ayrtonsilas.com.br/api/download-apk </Text>
